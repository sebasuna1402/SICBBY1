...
trait TCliente{
	...
	public function setVoluntario(string $identificacion_volunteer, string $frist_name_volunteer, string $last_name_volunteer, string $email, string $address_volunteer, string $age_volunteer, string $mensaje, string $ocupation_volunteer, string $phone_number_volunteer){
		$this->con = new Mysql();
