      ...
      <ul class="app-menu">
        ...
        <li>
            <a class="app-menu__item" href="<?= base_url(); ?>/voluntarios">
                <i class="app-menu__icon fas fa-handshake" aria-hidden="true"></i>
        ...
        <li class="treeview">
            <a class="app-menu__item" href="#" data-toggle="treeview">
                ...
                <span class="app-menu__label">Documentacion</span>
                <i class="treeview-indicator fa fa-angle-right"></i>
            </a>
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="<?= base_url(); ?>/DocumentacionI"><i class="icon fa fa-circle-o"></i> Interna</a></li>
                <li><a class="treeview-item" href="<?= base_url(); ?>/DocumentacionE"><i class="icon fa fa-circle-o"></i> Externa</a></li>
            </ul>
        </li>
        <?php } ?>
