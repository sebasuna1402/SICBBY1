...
class Paginas extends Controllers{
	...
	public function paginas()
	{
		...
		$data['page_title'] = "PÁGINAS <small>CBYY</small>";
	...
	public function editar($idpost){
		...
		if($idpost > 0){
			...
			$data['page_title'] = "ACTUALIZAR PÁGINA <small>Corredor Virtual</small>";
	...
	public function crear(){
		...
		$data['page_title'] = "CREAR PÁGINA <small>CCorredor Virtual</small>";
